...
import nuxt_plugin_router_187f60fb from 'nuxt_plugin_router_187f60fb' // Source: .\\router.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Statybų projektas","titleTemplate":"%s - Statybų projektas","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Nuxt.js project"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_router_187f60fb === 'function') {
    await nuxt_plugin_router_187f60fb(app.context, inject)
  }
